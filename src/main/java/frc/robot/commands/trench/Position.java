...
public class Position extends CommandBase {
    ...
    private NetworkTableEntry colorEntry = OIConstants.kTab.add("positionColor", "none").getEntry();
    private boolean colorSent = false;    
    ...
    public void initialize() {
        ...
        if (gameData.length() > 0) {
            if (!colorSent) {
                colorEntry.forceSetString(gameData);
                colorSent = true;
            }
